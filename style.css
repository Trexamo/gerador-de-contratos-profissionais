...
:root {
    ...
    --shadow-lg: 0 20px 40px -10px rgba(0, 0, 0, 0.15), 0 10px 15px -5px rgba(0, 0, 0, 0.1);
...
.btn-accent:hover {
    background: linear-gradient(135deg, var(--accent-dark) 0%, #0e7490 100%);
}
...
/* ===== ESTILOS ADICIONAIS QUE ESTAVAM FALTANDO ===== */
