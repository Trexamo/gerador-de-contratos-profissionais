...
<head>
    ...
    <title>ContratoFácil - Contratos Profissionais em 5 Minutos</title>
    <link rel="icon" href="logo.jpg" type="image/jpeg">
    <link rel="stylesheet" href="style.css">
    <!-- Correções de Mobile e Bugs -->
...
(function() {
    console.log('📱 Aplicando correções mobile de emergência...');
    
    // 1. Corrigir o bug do zoom out
    ...
    // 2. Corrigir layout do gerador em mobile
    ...
    // 3. Corrigir abertura do view-contract
    window.openSecurePreview = function() {
        ...
        try {
            ...
            if (isMobile) {
                // Em mobile, abrir na mesma janela
                ...
                window.location.href = 'view-contract.html?mobile=true&t=' + Date.now();
            } else {
                // Em desktop, abrir nova janela
                const encodedData = btoa(encodeURIComponent(JSON.stringify(contractData)));
                const viewUrl = `view-contract.html?data=${encodedData}&t=${Date.now()}`;
                
                const newWindow = window.open(viewUrl, '_blank', 'width=1200,height=700');
...
<body>
        ...
        <div class="container">
            <div class="status-content">
                <div class="status-info">
                    ...
                    <span id="statusText">Plano Gratuito - Visualizações Ilimitadas</span>
                </div>
            ...
            <div class="header-content">
                ...
                <nav class="nav-menu">
                    <ul>
                        ...
                        <!-- Área do usuário (aparece quando logado) -->
                ...
                <div class="auth-buttons">
                    ...
                    <div id="loginButton" class="auth-button">
                        <button class="btn-login" onclick="showLoginModal()">
                            <i class="fas fa-sign-in-alt"></i> <span class="auth-text">Entrar</span>
                        </button>
                    </div>
                    
                    <!-- Botão do usuário (visível quando logado) -->
                    <div id="userButton" class="auth-button" style="display: none;">
                        <a href="user.html" class="btn-login user-info">
                            <i class="fas fa-user-circle"></i> 
                            <span class="auth-text" id="userNameButton">Minha Conta</span>
                        </a>
                    </div>
                </div>
    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                ...
                <p>
                    Crie contratos juridicamente válidos com nosso gerador inteligente. 
        ...
        <div class="container">
            <div class="video-container">
                ...
                <div class="video-wrapper" id="videoWrapper">
                    <video controls autoplay muted playsinline class="intro-video" 
                           poster="video-poster.jpg" id="mainVideo"
                           onerror="handleVideoError()">
                        <source src="video.mp4" type="video/mp4">
                        <source src="video.webm" type="video/webm">
                        Seu navegador não suporta o elemento de vídeo.
                    </video>
                    <div id="videoFallback" style="display: none; padding: 20px; text-align: center;">
                        <p>⚠️ O vídeo não pôde ser carregado. Você pode continuar criando seu contrato.</p>
                        <button class="btn" onclick="scrollToGenerator()">
        ...
        <div class="container">
            ...
            <div id="loginRequired" class="login-required" style="display: none;">
                <div class="login-required-content">
                    ...
                    <p>Faça login para criar e visualizar contratos</p>
                    <button class="btn-login" onclick="showLoginModal()">
            ...
            <div class="generator-container" id="generatorForm" style="display: none;">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="contractorProfession">Profissão do Contratante</label>
                            <input type="text" id="contractorProfession" placeholder="Sua profissão">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="contractedProfession">Profissão do Contratado</label>
                            <input type="text" id="contractedProfession" placeholder="Profissão do prestador">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="serviceDescription" rows="4" placeholder="Descreva detalhadamente o serviço a ser prestado" aria-required="true"></textarea>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label for="serviceValue">Valor do Serviço (R$) *</label>
                    ...
                    <div class="signature-options">
                        ...
                        <div class="signature-option" onclick="selectSignatureOption('contracted', 'upload', event)">
                            ...
                            <p>Faça upload de uma imagem da sua assinatura (JPG, PNG)</p>
                        ...
                        <div class="signature-preview" id="contractedSignaturePreview">
                            <p style="color: #666; text-align: center;">Assinatura do Contratado aparecerá aqui</p>
                        </div>
                    ...
                    <div class="signature-options">
                        ...
                        <div class="signature-preview" id="contractorSignaturePreview">
                            <p style="color: #666; text-align: center;">Assinatura do Contratante aparecerá aqui</p>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="contractCity">Cidade de Vigência *</label>
                        <input type="text" id="contractCity" placeholder="Cidade onde o contrato é válido" aria-required="true">
                    </div>
                ...
                <div class="preview-section">
                    <div class="preview-header">
                        <h3>Pré-visualização do Seu Contrato</h3>
                        <p class="preview-notice">✅ Visualização gratuita - Faça upgrade para baixar</p>
                    </div>
                    <div class="contract-preview" id="contractPreview">
                        <!-- CONTRATO PROFISSIONAL SERÁ INSERIDO AQUI VIA JAVASCRIPT -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer com link de administração escondido -->
    <footer>
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <ul>
                        ...
                        <!-- Link de administração escondido -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="login-modal-content">
                    ...
                    <div id="googleSignInContainer" style="margin: 2rem 0; text-align: center;">
                        <div id="g_id_onload"
                    ...
                    <p class="login-terms" style="font-size: 0.85rem; color: #666; margin-top: 1.5rem;">
                        Ao entrar, você concorda com nossos 
                        <a href="termos-de-uso.html" style="color: var(--primary);">Termos de Serviço</a> e 
                        <a href="politica-de-privacidade.html" style="color: var(--primary);">Política de Privacidade</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
    // Função para abrir visualização segura CORRIGIDA
    function openSecurePreview() {
        ...
        try {
            ...
            // Formatar os dados para passar via URL
            const encodedData = btoa(JSON.stringify(contractData));
            
            // Criar um formulário temporário para enviar os dados
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'view-contract.html';
            form.target = '_blank';
            form.style.display = 'none';
            
            const input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'contractData';
